            ...
            print(
                format_str.format(
                    ...
                    dt.datetime.fromtimestamp(
                        float(msg["booking"].get("confirm_time", 0))
                    ),
                    dt.datetime.fromtimestamp(
                        int(msg["booking"].get("check_in_time", 0))
                    ),
...
config_data = toml.load("./utils/config.toml")
...
class HDULIB:
    def __init__(self, user: User) -> None:
        ...
        self.login(user.user_name, user.password)
    ...
    def login(self, login_name: str, pwd: str) -> str:
        login_data = {
    ...
    def get_seat_data(
        self,
        seat_number: Optional[str | int],
        space_id: Optional[str | int],
    ) -> dict:
        seat_param = {
